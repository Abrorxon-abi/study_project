                ...
                <div className="upper-nav">
                    ...
                    <div className="right-nav">
                        <span className='nav-link'>
                            <Link to={'#'}>
                                english
                                <img src={bottomVector} alt="" width={10} height={5} />
                            </Link>
                        </span>
                        <span className='nav-link'>
                            <Link to={'#'}>
                        ...
                        <span className='nav-link'>
                            <Link to={'#'}>
                                Login
                                <img src={profileVector} alt="" width={15} height={15} />
                            </Link>
                        </span>
                        <span className='nav-link'>
                            <Link to={'#'}>
                                Wishlist
                                <img src={wishlistVector} alt="" width={15} height={15} />
                            </Link>
                        </span>
                        <span className='nav-link'>
                            <Link to={'#'}>
                                <img src={cardVector} alt="" width={20} height={20} />
                            </Link>
                        </span>
                    </div>
                </div>
